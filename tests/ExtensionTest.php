...
use Bolt\Extension\Ohlandt\RequiredRecords\RequiredRecordsExtension;

/**
 * Required Records testing class.
 *
...
{
    /**
     * Ensure that the Required Records extension loads correctly.
     */
    public function testExtensionBasics()
    {
        $app = $this->getApp(false);
        $extension = new RequiredRecordsExtension($app);

        $name = $extension->getName();
        $this->assertSame($name, 'RequiredRecords');
